...
export async function parseAdHandler(req: Request, res: Response): Promise<void> {
  try {
    ...
    const description: string | null = extractNextDataField(data, 'props.initialState.adView.data.description')
      .replace(/\n+/g, ' ')
      .trim();
